...
from src.models.only_pre_prompt import OnlyPrePromptAdapter
...
output_data_dir = "./demo/inpainting_data_v5_zoom_up_only_6_encoder_pre_prompt"

checkpoint_dir = "./output/0415_inpainting_data_v5_zoom_up_only_6_encoder_pre_prompt_epoch_10_lr_1e-5"
...
def image_inpainting(pipe, img_index, prompt_text, adapter=None, text_mapper=None):
    ...
    # ipdb.set_trace()
    prompt = "Write english text '" + prompt_text + "'."
