...
from .unet_2d_blocks_with_adapter import get_down_block
...
class UNet2DConditionWithAdapterModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
        ...
        for idx, downsample_block in enumerate(self.down_blocks):
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                sample, res_samples = downsample_block(
                    ...
                    extra_condition=extra_condition[idx],
                )
            else:
