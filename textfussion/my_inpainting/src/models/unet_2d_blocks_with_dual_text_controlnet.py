...
from .transformer_2d_with_dual_text_controlnet import Transformer2DModel
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        self, hidden_states, temb=None, encoder_hidden_states=None, attention_mask=None, cross_attention_kwargs=None,
            extra_condition=None, char_embedding=None,
    ):
...
class DownBlock2D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, extra_condition=None):
        output_states = ()
...
class CrossAttnUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        for resnet, attn in zip(self.resnets, self.attentions):
            ...
            if extra_condition_tuple:
                extra_condition = extra_condition_tuple[-1]
                extra_condition_tuple = extra_condition_tuple[:-1]
                res_hidden_states = res_hidden_states + extra_condition
...
class UpBlock2D(nn.Module):
    ...
    def forward(self, hidden_states, res_hidden_states_tuple, temb=None, upsample_size=None, extra_condition_tuple=None,
                char_embedding=None):
        for resnet in self.resnets:
            # pop res hidden states
            res_hidden_states = res_hidden_states_tuple[-1]
