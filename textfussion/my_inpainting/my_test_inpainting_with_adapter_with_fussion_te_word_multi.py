...
from src.models.adapter_with_fussion_TE import WithFussionTEAdapter
...
output_data_dir = "./demo/inpainting_with_adapter_with_fussion_te"

checkpoint_dir = "./output/0406_inpainting_with_adapter_with_fussion_te"
