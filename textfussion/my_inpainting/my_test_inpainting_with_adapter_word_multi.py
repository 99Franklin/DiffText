...
output_data_dir = "./demo/inpainting_with_adapter_real_word_text_guide_epoch_50e_lr_1e-5"

checkpoint_dir = "./output/0329_inpainting_with_single_adapter_real_word_text_guide_epoch_50e_lr_1e-5"
