...
from src.build_synth_data.crop_tools import crop_image_regions, replace_crop_region, get_chosen_regions, bezier_edge
...
output_data_dir = \
    "/data2/lfu/datasets/scene_text/build_synthtext/my_synth_data/new_paradigm_1012_baseline_repeat"
# output_data_dir = \
#     "/data2/lfu/datasets/scene_text/build_synthtext/my_synth_data/try"
...
if __name__ == '__main__':
    ...
    for input_item in tqdm(total_data_list, ncols=80):
        ...
        # input_item = bezier_edge(input_item, (width, height))
