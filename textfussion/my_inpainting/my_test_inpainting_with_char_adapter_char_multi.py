...
from src.models.adapter_with_char_embedding import CharAdapter
from src.models.unet_2d_with_adapter import UNet2DConditionWithAdapterModel
from src.pipelines.stable_diffusion_inpainting_with_char_adapter import StableDiffusionInpaintWithCharAdapterPipeline
...
output_data_dir = "./demo/inpainting_with_char_adapter_char_text_guide_epoch_2e_lr_1e-6_10"

checkpoint_dir = "./output/0327_inpainting_with_char_adapter_char_text_guide_epoch_2e_lr_1e-6"
...
def image_inpainting(pipe, img_index, prompt_text, adapter=None, text_mapper=None):
    ...
    image = pipe(prompt=prompt, text=prompt_text, image=init_image, mask_image=mask_image,
                 adapter=adapter, text_mapper=text_mapper).images[0]
...
if __name__ == '__main__':
    ...
    pipe = StableDiffusionInpaintWithCharAdapterPipeline(vae, text_encoder, tokenizer, unet, noise_scheduler, None)
    pipe = pipe.to("cuda")
