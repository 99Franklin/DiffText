...
from src.pipelines.stable_diffusion_inpainting_text_vae_text_glyph import TextVaeTextGlyphInpaintPipeline
...
output_data_dir = \
    "/data2/lfu/datasets/scene_text/build_synthtext/my_synth_data/new_paradigm_0607_text_vae_text_glyph_90_conf_35_angle"

checkpoint_dir = "./output/new_paradigm_0605_with_text_vae_add_glyph_2gpu_20epoch"
...
if __name__ == '__main__':
    ...
    pipe = TextVaeTextGlyphInpaintPipeline(vae, text_encoder, tokenizer, unet, noise_scheduler, None)
    pipe = pipe.to("cuda")
